...
class TestEDAAnalyzer:
    ...
    def test_analyze_target_variable_basic(self, eda_analyzer, sample_data, plots_dir):
        ...
        assert target_plots_dir.exists(), f"Target plots directory not found: {target_plots_dir}"
    ...
    def test_analyze_target_variable_custom_target(self, eda_analyzer, sample_data, plots_dir):
        ...
        analysis = eda_analyzer.analyze_target_variable(sample_data, target_col='custom_target')
    ...
    def test_analyze_target_variable_missing_target(self, eda_analyzer, sample_data):
        ...
        analysis = eda_analyzer.analyze_target_variable(sample_data, target_col='nonexistent_column')
        assert 'error' in analysis

    # ---------- Feature Distribution Tests ----------
    def test_analyze_feature_distributions_basic(self, eda_analyzer, sample_data, plots_dir):
        ...
        for col in numerical_cols:
            ...
            assert plot_file.exists(), f"Distribution plot not found for {col}: {plot_file}"
