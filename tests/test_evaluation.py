...
class TestModelEvaluator:
    ...
    def test_calculate_basic_metrics_multiclass(self, model_evaluator, sample_multiclass_data):
    ...
    def test_calculate_basic_metrics_without_probabilities(self, model_evaluator, sample_binary_data):
    ...
    def test_calculate_confusion_matrix_binary(self, model_evaluator, sample_binary_data):
    ...
    def test_calculate_confusion_matrix_multiclass(self, model_evaluator, sample_multiclass_data):
    ...
    def test_calculate_roc_curve_binary(self, model_evaluator, sample_binary_data):
        ...
        fpr, tpr, thresholds = model_evaluator._calculate_roc_curve(y_true, y_pred_proba)
    ...
    def test_calculate_roc_curve_multiclass(self, model_evaluator, sample_multiclass_data):
    ...
    def test_calculate_precision_recall_curve_binary(self, model_evaluator, sample_binary_data):
        """Test calculation of precision-recall curve for binary classification."""
        y_true, _, y_pred_proba = sample_binary_data
        
        precision, recall, thresholds = model_evaluator._calculate_precision_recall_curve(y_true, y_pred_proba)
    ...
    def test_calculate_precision_recall_curve_multiclass(self, model_evaluator, sample_multiclass_data):
    ...
    def test_evaluate_binary_complete(self, model_evaluator, sample_binary_data, temp_dir):
        ...
        try:
            ...
            results = model_evaluator.evaluate(y_true, y_pred, y_pred_proba, dataset_name="test")
    ...
    def test_evaluate_without_probabilities(self, model_evaluator, sample_binary_data, temp_dir):
    ...
    def test_get_metrics_before_evaluation(self, model_evaluator):
        ...
        with pytest.raises(ValueError, match="No metrics available. Run evaluate\\(\\) first."):
    ...
    def test_get_confusion_matrix_before_evaluation(self, model_evaluator):
        ...
        with pytest.raises(ValueError, match="No confusion matrix available. Run evaluate\\(\\) first."):
    ...
    def test_save_metrics_custom_path(self, model_evaluator, sample_binary_data, temp_dir):
    ...
    def test_save_metrics_before_evaluation(self, model_evaluator):
        ...
        with pytest.raises(ValueError, match="No metrics to save. Run evaluate\\(\\) first."):
            model_evaluator.save_metrics()

    @patch.object(builtins, 'open', side_effect=IOError("Disk full"))
    def test_save_metrics_io_error(self, mock_open, model_evaluator, sample_binary_data, temp_dir):
