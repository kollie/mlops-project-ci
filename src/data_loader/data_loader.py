...
class DataLoader:
    ...
    def load_data(self, file_path: str = None) -> pd.DataFrame:
        ...
        try:
            ...
            if not data_path:
                raise ValueError("Missing 'raw_data_path' in config and no file_path provided.")
            ...
            if data_format == 'csv':
                ...
                raise ValueError(f"Unsupported file format: {data_format}. Supported formats: csv, excel")
    ...
    def save_split_data(self, train: pd.DataFrame, val: pd.DataFrame, test: pd.DataFrame):
        ...
        try:
            ...
            required_paths = ['processed_data_path', 'train_data_path', 'validation_data_path', 'test_data_path']
            ...
            self.logger.info(f"Train data saved to: {self.config['data']['train_data_path']}")
            self.logger.info(f"Validation data saved to: {self.config['data']['validation_data_path']}")
            self.logger.info(f"Test data saved to: {self.config['data']['test_data_path']}")
